...
HEATMAP_RADIUS  = 25    # heat blob size in pixels  (12–18 is good)
HEATMAP_BLUR    = 15    # edge softness
HEATMAP_OPACITY = 0.3   # 0 = invisible  1 = solid

# Max dots to draw on map.  More = slower browser.  500 is safe.
MAX_MARKERS = 3500

# Map background.  Pick one:
...
if CRIME_FILTER == 'all':
    filtered  = df.copy()
    map_title = 'All Karnataka Crimes'
else:
...
<div style="
  ...
  <div style="margin-top:6px;">
    ...
    <span style="display:inline-block;width:10px;height:10px;border-radius:50%;
          background:cyan;margin-right:6px;margin-top:3px;"></span>Kidnaap<br>
    <span style="display:inline-block;width:10px;height:10px;border-radius:50%;
          background:black;margin-right:6px;margin-top:3px;"></span>chain snatching<br>
    <span style="display:inline-block;width:10px;height:10px;border-radius:50%;
